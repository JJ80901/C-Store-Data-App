...
def addReceipt(url):
    ...
    return new_receipt_df

# Display the updated DataFrame
receipt_df = addReceipt(url)
receipt_df = pd.concat([receipt_df, addReceipt('https://receipt.365retailmarkets.com/receipt/view?transid=VSH603038-230201069594&receipttype=SALES_RECEIPT')])
print(receipt_df)